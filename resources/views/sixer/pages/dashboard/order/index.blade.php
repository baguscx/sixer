                                    ...
                                    <tr class="text-gray-700 border-b">
                                            ...
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if ($order->user_buyer->detail_user->photo != null)
                                                        <img class="object-cover w-full h-full rounded-full" src="{{url(Storage::url($order->user_buyer->detail_user->photo))}}" alt="photo profile" loading="lazy" />
                                                    @else
                                                        <svg class="object-cover w-full h-full rounded-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                            <path fill-rule="evenodd" d="M10 0a10 10 0 100 20 10 10 0 000-20zm0 18a8 8 0 100-16 8 8 0 000 16zm0-9a1 1 0 011 1v3a1 1 0 01-2 0v-3a1 1 0 011-1zm0-5a1 1 0 011 1v1a1 1 0 01-2 0V5a1 1 0 011-1z" clip-rule="evenodd" />
                                                        </svg>
                                                    @endif
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-400">{{$order->user_buyer->role ?? ''}}</p>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if ($order->service->thumbnail_service[0]->thumbnail != null)
                                                        <img class="object-cover w-full h-full rounded" src="{{url(Storage::url($order->service->thumbnail_service[0]->thumbnail))}}" alt="photo profile" loading="lazy" />
                                                    @else
                                                        <svg class="object-cover w-full h-full rounded" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"></svg>
                                                            <path fill-rule="evenodd" d="M10 0a10 10 0 100 20 10 10 0 000-20zm0 18a8 8 0 100-16 8 8 0 000 16zm0-9a1 1 0 011 1v3a1 1 0 01-2 0v-3a1 1 0 011-1zm0-5a1 1 0 011 1v1a1 1 0 01-2 0V5a1 1 0 011-1z" clip-rule="evenodd" />
                                                        </svg>
                                                    @endif
                                                    <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                        ...
                                        <td class="px-1 py-5 text-sm">
                                            @if ($order->order_status_id == '1')
                                                ...
                                                <p href="#" class="px-4 py-2 mt-2 text-left inline text-green-500">
                                                    Approved
                                                </p>
                                            @elseif ($order->order_status_id == '2')
                                                ...
                                                <a href="{{route('member.order.edit', $order->id)}}" class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">
                                                    submit
                                                </a>
                                            @elseif ($order->order_status_id == '3')
                                                ...
                                                <p class="px-4 py-2 mt-2 text-left inline text-red-500">
                                                    rejected
                                                </p>
