            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                <div class="col-span-8">
                    ...
                    <p class="text-sm text-gray-400">
                        {{ count(Auth::user()->order_buyer ) }} Total Requests
                    </p>
                </div>
                                            ...
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                ...
                                                @else
                                                    <svg class="object-cover w-full h-full rounded-full" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"></svg>
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6a4 4 0 100-8 4 4 0 000 8z" />
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14a9 9 0 100-18 9 9 0 000 18z" />
                                                    </svg>
                                                @endif
                                    ...
                                    <td class="w-2/6 px-1 py-5">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                ...
                                                @else
                                                    <svg class="object-cover w-full h-full rounded" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"></svg>
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6a4 4 0 100-8 4 4 0 000 8z" />
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14a9 9 0 100-18 9 9 0 000 18z" />
                                                    </svg>
                                                @endif
                        ...
                        <div class="flex p-8 border border-gray-200 rounded-lg bg-serv-upload-bg h-128">
                            <div class="m-auto text-center">
                                ...
                                <div class="relative mt-0 md:mt-6">
                                    @if (isset($order->file))
                                        <a href="{{url(Storage::url($order->file ?? ''))}}" class="px-4 py-2 mt-2 text-left text-gray-700 rounded-xl bg-serv-hr" onclick="return confirm('Yakin download ini??')">Download File</a>
                                    @else
                                        <p class="text-sm text-gray-400">
                                            File not available
                                        </p>
