        ...
        <div class="grid gap-5 md:grid-cols-12">
                ...
                <div class="content">
                    <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'description' }" id="tab_wrapper">
                                ...
                                <div class="flex items-center col-span-12 p-2 lg:col-span-6">
                                    <div class="flex items-center space-x-4">
                                        @if ($service->user->detail_user->photo != null)
                                            <img src="{{url(Storage::url($service->user->detail_user->photo))}}" loading="lazy" alt="My profile" class="w-20 h-20 rounded-full ">
                                        @else
                                            <svg class="w-3 h-3 mx-3 text-gray-400 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                                <path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z" />
                                            </svg>
                        ...
                        <div x-show.transition.duration.500ms="tab === 'reviews'">
                            ...
                            @include('sixer.components.landing.review')
                            @include('sixer.components.landing.review')
                            @include('sixer.components.landing.review')
                        </div>
                    </div>
            ...
            <aside class="p-4 lg:col-span-4 md:col-span-12 md:pt-0">
                <div class="mb-4 border rounded-lg border-serv-testimonial-border">
                    ...
                    @if ($service->user->detail_user->photo != null)
                        <img src="{{url(Storage::url($service->user->detail_user->photo))}}" loading="lazy" alt="My profile" class="object-cover w-16 h-16 mr-4 rounded-full">
                    @else
                        <svg class="w-3 h-3 mx-3 text-gray-400 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                            <path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z" />
                        </svg>
...
@push('after-script')
    <script>
        function gallery(){
            return{
                featured:'{{Storage::url($thumbnail[0]->thumbnail)}}',
                active: 1,
                changeThumbnail(url, position){
                    this.featured = url;
