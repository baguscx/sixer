    ...
    <div class="text-serv-bg">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm {{request()->is('member/dashboard') ? 'font-medium text-gray-800' : 'font-light'}} transition-colors duration-150 hover:text-gray-800 " href="{{route('member.dashboard.index')}}">
                ...
                @else
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19.5 16V9.02123C19.5 7.75027 18.896 6.55494 17.8728 5.80101L12.3728 1.74838C10.9618 0.708674 9.03823 0.708675 7.6272 1.74838L2.1272 5.80101C1.10401 6.55494 0.5 7.75027 0.5 9.02123V16C0.5 18.2091 2.29086 20 4.5 20H5.75C6.57843 20 7.25 19.3284 7.25 18.5V16C7.25 15.1716 7.92157 14.5 8.75 14.5H11.25C12.0784 14.5 12.75 15.1716 12.75 16V18.5C12.75 19.3284 13.4216 20 14.25 20H15.5C17.7091 20 19.5 18.2091 19.5 16Z" stroke="#082431" stroke-width="1.5"/>
                    </svg>
                @endif
        ...
        <ul>
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full {{request()->is('member/service') ? 'font-medium text-gray-800' : 'font-light'}} text-sm transition-colors duration-150 hover:text-gray-800" href="{{route('member.service.index')}}">
            ...
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full text-sm {{request()->is('member/request') ? 'font-medium text-gray-800' : 'font-light'}} transition-colors duration-150 hover:text-gray-800" href="{{route('member.request.index')}}">
            ...
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full text-sm {{request()->is('member/order') ? 'font-medium text-gray-800' : 'font-light'}} transition-colors duration-150 hover:text-gray-800" href="{{route('member.order.index')}}">
            ...
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full text-sm {{request()->is('member/profile') ? 'font-medium text-gray-800' : 'font-light'}} transition-colors duration-150 hover:text-gray-800" href="{{route('member.profile.index')}}">
                    @if (request()->is('member/profile'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" />
                        <circle cx="10.5" cy="5.5" r="2.75" fill="#082431" stroke="#082431" stroke-width="1.5" />
                        <path d="M3.75 18.2581C3.75 14.6638 6.66376 11.75 10.2581 11.75H11.7419C15.3362 11.75 18.25 14.6638 18.25 18.2581C18.25 18.8059 17.8059 19.25 17.2581 19.25H4.74194C4.1941 19.25 3.75 18.8059 3.75 18.2581Z" stroke="#082431" fill="#082431" stroke-width="1.5" />
